...
public class PullDownScrollView extends LinearLayout {
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		if (ev.getAction() == MotionEvent.ACTION_MOVE) {
			...
			Logger.i(TAG, "isElastic:" + isElastic + " canScroll:"
	...
	public void computeScroll() {
		/*
		 * if (scroller.computeScrollOffset()) { int i =
		 * this.scroller.getCurrY(); LinearLayout.LayoutParams lp =
		 * (LinearLayout.LayoutParams) this.getLayoutParams(); int k =
		 * Math.max(i, refreshTargetTop); lp.topMargin = k;
		 * this.setLayoutParams(lp); this.invalidate(); invalidate(); }
		 */
	}
