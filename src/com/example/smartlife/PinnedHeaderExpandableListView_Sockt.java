...
public class PinnedHeaderExpandableListView_Sockt extends ExpandableListView
		implements OnScrollListener, OnGroupClickListener {
	public PinnedHeaderExpandableListView_Sockt(Context context,AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		registerListener();
	}

	public PinnedHeaderExpandableListView_Sockt(Context context,AttributeSet attrs) {
		super(context, attrs);
		registerListener();
	}

	public PinnedHeaderExpandableListView_Sockt(Context context) {
		super(context);
		registerListener();
	}
...
/*	@Override
	public boolean onChildClick(ExpandableListView arg0, View arg1, int arg2,
		...
		Toast.makeText(getContext(), "开关" + arg2 + "-" + arg3,Toast.LENGTH_SHORT).show();
		return false;
	}*/
}