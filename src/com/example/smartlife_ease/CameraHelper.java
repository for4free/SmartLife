...
import com.example.smartlife_ease.App_Ease;
...
//            yuv_Rotate90lr = new byte[mwidth * mheight * bitsperpixel / 8];
    ...
    boolean isScreenOriatationPortrait() {
        return App_Ease.applicationContext.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
    }
}
