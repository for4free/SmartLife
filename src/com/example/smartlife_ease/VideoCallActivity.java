                ...
                case CONNECTING: // 正在连接对方
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                        	...
                        	//Toast.makeText(getBaseContext(), "正在打开监控", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (fError == CallError.REJECTED) {
                            	...
                            	Toast.makeText(getBaseContext(), "打开监控设备失败", Toast.LENGTH_SHORT).show();
                               ...
                               // callStateTextView.setText(s3);
                                ...
                                Toast.makeText(getBaseContext(), "设备占用，请稍后打开", Toast.LENGTH_SHORT).show();
...
//                                        callStateTextView.setText(s6);
    ...
    public void onClick(View v) {
        ...
        case R.id.iv_mute: // 静音开关
            ...
            break;
        case R.id.main_doorbell_btn_back:  //titlebar返回
        	hangupBtn.setEnabled(false);
            if (soundPool != null)
                soundPool.stop(streamID);
            chronometer.stop();
